...
.NOTES
    Executar com:
        irm https://raw.githubusercontent.com/SEU_USER/guiport/main/Guiport.ps1 | iex
    Ou localmente:
...
if (-not ([Security.Principal.WindowsPrincipal][Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole(
    ...
    $script = if ($PSCommandPath) {
        ...
        "&([ScriptBlock]::Create((irm https://raw.githubusercontent.com/SEU_USER/guiport/main/Guiport.ps1)))"
    }
